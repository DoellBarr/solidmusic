    ...
    async def _stream(
        ...
        if playlist:
            if len(playlist[chat_id]) >= 1:
                self.extend_playlist(user_id, chat_id, title, duration, yt_url, yt_id, "video")
        ...
        try:
            await self._set_streaming(
                chat_id, user_id, video_url, quality, title, duration, yt_url, yt_id, messy
            )
